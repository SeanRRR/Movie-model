...
def get_prepared_data(data_path="data", k_best=100):
    ...
    # Ensure 'Released_Year' exists
    if 'Released_Year' not in data.columns:
        raise KeyError("The 'Released_Year' column is missing from the dataset.")
    ...
    #data.to_csv('data/imdb_top_1000.csv', index=False)
